...
logging_log('INFO', 'Loading set file: ./sub-006/eeg/sub-006_task-faceFO_compart_data.set...');
tic;
EEG = pop_loadset('filepath','derivatives/BIDS-Lossless-EEG','filename','./sub-006/eeg/sub-006_task-faceFO_compart_data.set');
...
tic;
EEG.amica(2).models=loadmodout15('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_A');
...
% Load Amica B
EEG.amica(3).models=loadmodout15('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_B');
% Load Amica C
EEG.amica(4).models=loadmodout15('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_C');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
logging_log('INFO','Saving set file: derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_eeg_ll.set...');
tic;
EEG = pop_saveset( EEG, 'filename','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_eeg_ll.set');
logging_log('INFO','TIME TO: SAVE DIP DATA SET...');
toc

% Save diagnostic arrays
try OCTAVE_VERSION;
    save('-mat7-binary','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_icaact_sd2_t.mat','icaact_sd2_t');
catch
    save('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_icaact_sd2_t.mat','icaact_sd2_t');
end
...
% Reload dataset:
EEG = pop_loadset('filepath','derivatives/BIDS-Lossless-EEG','filename','./sub-006/eeg/sub-006_task-faceFO_eeg_ll.set');
EEG = eeg_checkset(EEG);
...
fName = './derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_eeg.edf';
