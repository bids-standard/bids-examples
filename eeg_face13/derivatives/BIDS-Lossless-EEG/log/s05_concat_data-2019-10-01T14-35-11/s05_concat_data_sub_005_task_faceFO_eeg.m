...
%-----------------------------------------------------------------------------------------------------------------------------
%  in_path = 		derivatives/BIDS-Lossless-EEG  	    Relative path to input data files assuming cd = work_path
%  recur_sec = 		1  	Recurrence (sec) for the current artifact detection epoching (e.g. 1)
%  limit_sec = 		[0 1]  	Limits (sec) for the current artifact detection epoching (e.g. [0 1])
...
%  dip_vol =        derivatives/BIDS-Lossless-EEG/code/misc/standard_vol.mat       file path/name of the standard volume file used in dipole fitting (e.g. derivatives/lossless/code/misc/standard_vol.mat).
%  dip_mri =        derivatives/BIDS-Lossless-EEG/code/misc/standard_mri.mat       file path/name of the standard mri file used in dipole fitting (e.g. derivatives/lossless/code/misc/standard_mri.mat).
%  dip_elc =        derivatives/BIDS-Lossless-EEG/code/misc/standard_1020.elc       file path/name of the standard electrode file used in dipole fitting (derivatives/lossless/code/misc/standard_1020.elc).
%  dip_transmat =   [0 0 0 0 0 0 1 1 1]  Transformation matrix to apply during dipole fit (e.g. [0 0 0 0 0 0 1 1 1])
%  cor_transmat =   [0,0,0,0,0,1.57,1,1,1]  The transformation matrix to apply between dipole fitting to the standard head and performing ICLabel to the EEGLAB default orientation (e.g.[0,0,0,0,0,1.57,1,1,1])
...
logging_log('INFO', 'Loading set file: ./sub-005/eeg/sub-005_task-faceFO_compart_data.set...');
tic;
EEG = pop_loadset('filepath','derivatives/BIDS-Lossless-EEG','filename','./sub-005/eeg/sub-005_task-faceFO_compart_data.set');
...
tic;
EEG.amica(2).models=loadmodout15('derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_amicaout_A');
...
% Load Amica B
EEG.amica(3).models=loadmodout15('derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_amicaout_B');
% Load Amica C
EEG.amica(4).models=loadmodout15('derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_amicaout_C');
...
% TODO(mae) this isn't added for some reason
addpath([pwd '/derivatives/BIDS-Lossless-EEG/code/dependencies/eeglab_lossless/plugins/Fieldtrip-lite141209/src'])
...
tic;
EEG = pop_dipfit_settings( EEG, 'hdmfile','derivatives/BIDS-Lossless-EEG/code/misc/standard_vol.mat', ... 
				'coordformat','MNI', ...
				'mrifile','derivatives/BIDS-Lossless-EEG/code/misc/standard_mri.mat', ... 
				'chanfile','derivatives/BIDS-Lossless-EEG/code/misc/standard_1020.elc', ...
...
EEG = warp_locs( EEG, 'derivatives/BIDS-Lossless-EEG/code/misc/standard_1020.elc', ...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
logging_log('INFO','Saving set file: derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_eeg_ll.set...');
tic;
EEG = pop_saveset( EEG, 'filename','derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_eeg_ll.set');
logging_log('INFO','TIME TO: SAVE DIP DATA SET...');
toc

% Save diagnostic arrays
try OCTAVE_VERSION;
    save('-mat7-binary','derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_icaact_sd2_t.mat','icaact_sd2_t');
catch
    save('derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_icaact_sd2_t.mat','icaact_sd2_t');
end
...
% Reload dataset:
EEG = pop_loadset('filepath','derivatives/BIDS-Lossless-EEG','filename','./sub-005/eeg/sub-005_task-faceFO_eeg_ll.set');
EEG = eeg_checkset(EEG);
...
fName = './derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_eeg.edf';
...
export_anno(EEG,fName,'');

% ICLabel quick export
iclFname = strrep(fName,'_eeg.edf','_iclabel.mat');
