...
logging_log('INFO', 'Loading set file: ./sub-006/eeg/sub-006_task-faceFO_sa.set...');
tic;
EEG = pop_loadset('filepath','derivatives/BIDS-Lossless-EEG','filename','./sub-006/eeg/sub-006_task-faceFO_sa.set');
...
% Load AMICA Model 1
tic;
EEG.amica(1).models=loadmodout15('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_init');
...
tic;
logging_log('INFO', 'Saving file: ./sub-006/eeg/sub-006_task-faceFO_compart_data.set...');
EEG = pop_saveset( EEG, 'filename','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_compart_data.set');
...
sprintf('%s','Saving file: ./sub-006/eeg/sub-006_task-faceFO_compart_data_purge.set...\n');
EEG = pop_saveset( EEG, 'filename','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_compart_data_purge.set');

% Save diagnostic arrays
try OCTAVE_VERSION;
    save('-mat7-binary','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_icaact_sd1_t.mat','icaact_sd1_t');
catch
    save('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_icaact_sd1_t.mat','icaact_sd1_t');
end
...
swapstr=file_strswap('derivatives/BIDS-Lossless-EEG/code/misc/amica_default.param', ...
			'[repstr_fdt_fname]','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_compart_data_purge.fdt', ...
			'[repstr_outpath]','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_A', ...
			'[repstr_nbchan]', num2str(EEG.nbchan), ...
			'[repstr_pnts]', sprintf('%12.0f',EEG.pnts), ...
            '[repstr_tpp]', '8', ...
			'[repstr_pca]', num2str(EEG.nbchan));
fidparam=fopen('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_A.param','w');
...
swapstr=file_strswap('derivatives/BIDS-Lossless-EEG/code/misc/amica_default.param', ...
			'[repstr_fdt_fname]','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_compart_data_purge.fdt', ...
			'[repstr_outpath]','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_B', ...
			'[repstr_nbchan]', num2str(EEG.nbchan), ...
			'[repstr_pnts]', sprintf('%12.0f',EEG.pnts), ...
            '[repstr_tpp]', '8', ...
			'[repstr_pca]', num2str(EEG.nbchan));
fidparam=fopen('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_B.param','w');
fprintf(fidparam,'%s',swapstr);
fclose(fidparam);
...
swapstr=file_strswap('derivatives/BIDS-Lossless-EEG/code/misc/amica_default.param', ...
			'[repstr_fdt_fname]','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_compart_data_purge.fdt', ...
			'[repstr_outpath]','derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_C', ...
			'[repstr_nbchan]', num2str(EEG.nbchan), ...
			'[repstr_pnts]', sprintf('%12.0f',EEG.pnts), ...
            '[repstr_tpp]', '8', ...
			'[repstr_pca]', num2str(EEG.nbchan));
fidparam=fopen('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_C.param','w');
fprintf(fidparam,'%s',swapstr);
fclose(fidparam);
...
[~] = rmdir('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_A','s');
[~] = rmdir('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_B','s');
[~] = rmdir('derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_C','s');


mkdir 'derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_A';
mkdir 'derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_B';
mkdir 'derivatives/BIDS-Lossless-EEG/./sub-006/eeg/sub-006_task-faceFO_amicaout_C';
