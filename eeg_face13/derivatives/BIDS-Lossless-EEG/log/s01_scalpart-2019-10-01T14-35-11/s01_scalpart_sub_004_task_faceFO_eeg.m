...
%                                            ... or a a file containing a transformation matrix (e.g. ./sub-004/eeg/sub-004_task-faceFO_eeg.edf_transmat.mat).
...
if ~exist('derivatives/BIDS-Lossless-EEG/./sub-004/eeg','dir');
    disp('Making directory derivatives/BIDS-Lossless-EEG/./sub-004/eeg');
    mkdir derivatives/BIDS-Lossless-EEG/./sub-004/eeg
end

%% LOAD DATASET
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
EEG = pop_bidsload('./sub-004/eeg/sub-004_task-faceFO_eeg.edf','gui',0);
...
if([1]);
    ...
    if 1
        ...
        logging_log('DEBUG', 'Saving file: derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_hpd.mat...');
        data = pre_hp_data - EEG.data;
        try OCTAVE_VERSION;
            save('-mat7-binary','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_hpd.mat','data');
        catch
            save('derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_hpd.mat','data');
        end
        logging_log('DEBUG', 'TIME TO: SAVE derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_hpd.mat FILE...');
    end
...
if([100]);
    ...
    if 1
        % Save high pass filter residual data array
        logging_log('DEBUG', 'Saving file: derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_lpd.mat...');
        data = pre_lp_data - EEG.data;
        try OCTAVE_VERSION;
            save('-mat7-binary','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_lpd.mat','data');
        catch
            save('derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_lpd.mat','data');
        end
        logging_log('DEBUG', 'TIME TO: SAVE derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_lpd.mat FILE...');
    end
...
%% SAVE sa.set FILE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
logging_log('INFO', 'Saving file: ./sub-004/eeg/sub-004_task-faceFO_sa.set...');
if ~exist('derivatives/BIDS-Lossless-EEG/./sub-004/eeg','dir');
    mkdir('derivatives/BIDS-Lossless-EEG/./sub-004/eeg');
end
EEG = pop_saveset( EEG, 'filename','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_sa.set');
...
logging_log('INFO',sprintf('%s','Saving file: derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_sa_purge.set...'));
EEG = pop_saveset( EEG, 'filename','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_sa_purge.set');

% Save diagnostic arrays
try OCTAVE_VERSION;
    save('-mat7-binary','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_data_sd_t.mat','data_sd_t');
    save('-mat7-binary','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_data_sd_ch.mat','data_sd_ch');
    save('-mat7-binary','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_data_r_ch.mat','data_r_ch');
    save('-mat7-binary','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_data_r_t.mat','data_r_t');
catch
    save('derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_data_sd_t.mat','data_sd_t');
    save('derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_data_sd_ch.mat','data_sd_ch');
    save('derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_data_r_ch.mat','data_r_ch');
    save('derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_data_r_t.mat','data_r_t');
end

% Save the AMICA parameter file
swapstr = file_strswap('derivatives/BIDS-Lossless-EEG/code/misc/amica15_default.param', ...
    '[repstr_fdt_fname]','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_sa_purge.fdt', ...
    '[repstr_outpath]','derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_amicaout_init', ...
    '[repstr_nbchan]', num2str(EEG.nbchan), ...
    '[repstr_pnts]', sprintf('%12.0f',EEG.pnts), ...
    '[repstr_tpp]', '8', ...
    '[repstr_pca]', num2str(EEG.nbchan));
fidparam = fopen('derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_init.param','w');
...
[~] = rmdir('derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_amicaout_init','s');
mkdir derivatives/BIDS-Lossless-EEG/./sub-004/eeg/sub-004_task-faceFO_amicaout_init;
