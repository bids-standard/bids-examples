%LOAD BIDS FILES
sphereLoc = 'derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_icasphere.tsv'
weightsLoc = 'derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_icaweights.tsv'
annoFile = 'derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_desc-qc_annotations.tsv'

elecFile = '././sub-005/eeg/sub-005_task-faceFO_electrodes.tsv'
eventsFile = '././sub-005/eeg/sub-005_task-faceFO_events.tsv'

EEG = pop_bidsload('derivatives/BIDS-Lossless-EEG/./sub-005/eeg/sub-005_task-faceFO_eeg.edf','elecLoc',elecFile,'eventLoc',eventsFile,'icaSphere',sphereLoc,'icaWeights',weightsLoc,'annoLoc',annoFile);

% add STUDY variables
% legacy mode for finding subject number.
myStr = './sub-005/eeg/sub-005_task-faceFO_eeg.edf';
...
%icaFileName = 'derivatives/BIDS-Lossless-EEG/derivatives/BIDS-Seg-Face13-EEGLAB/sub-005/eeg/sub-005_task-faceFO_icaweights.tsv';
...
%s.intendedFor = 'derivatives/BIDS-Lossless-EEG/derivatives/BIDS-Seg-Face13-EEGLAB/sub-005/eeg/sub-005_task-faceFO';
%savejson('',s,strrep(icaFileName,'_icaweights.tsv','_icaweights.json'));

tmpEEG=EEG;

% face-upright
outfname='derivatives/BIDS-Lossless-EEG/derivatives/BIDS-Seg-Face13-EEGLAB/sub-005/eeg/sub-005_task-faceFO_desc-SEGfaceu_eeg.edf'
...
% house-upright
outfname='derivatives/BIDS-Lossless-EEG/derivatives/BIDS-Seg-Face13-EEGLAB/sub-005/eeg/sub-005_task-faceFO_desc-SEGhousu_eeg.edf'
[outpath outname outext] = fileparts(outfname);
if ~exist(outpath,'dir')
    mkdir(outpath);
end
