...
-   This version of the specification erroneously refers to this example as "Case 2",
    ...
    This dataset has instead been named "ip112e3" and described as "the third example"
...
-   The proposal modification at the end of the description text
    is *not* realised in this example dataset;
    that is instead realised in sister dataset "ip112e3v2".
